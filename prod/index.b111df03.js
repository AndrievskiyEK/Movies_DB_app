...
// performing validation.
i=z(i);let l=r.Ru(o);if(i instanceof hy)s.push(o);else{let e=hv(i,l);null!=e&&(s.push(o),a.set(o,e))}});let o=new r1(s);return new hd(a,o,r.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,au.exists(!0))])}(n,{done:t})}console.log(hF);class h${constructor({onMovieChange:e}){this.movieList=[],this.onMovieChange=e}getMovies=e=>{this.movieList=e,console.log(this.movieList),this.onMovieChange(this.movieList)};addMovie=e=>{let t={data:Date.now(),name:e,done:!1};this.movieList.push(t),/* this.movieList.push({
            id: Date.now(),
            name: MovieName,
            done: false,
        }) */this.onMovieChange(this.movieList),hU(t)};deleteMovie=e=>{let t=this.movieList.findIndex(t=>t.id===e);this.movieList.splice(t,1),this.onMovieChange(this.movieList)};doneMovie=e=>{let t=this.movieList.find(t=>t.id===e);console.log(this.movieList),console.log(e);let n=!t.done;// Ввел переменную что бы передать ее в fb
